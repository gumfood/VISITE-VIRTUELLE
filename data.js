  ...
  "scenes": [
    {
      ...
      "image": {
        "base": "tiles/bureau-1/{z}/{f}/{y}/{x}.jpg",
        "format": "jpg",
        "size": 1024,
        "fallbackOnly": false
      },
    ...
    },
    {
      ...
      "image": {
        "base": "tiles/bureau-2-balcon/{z}/{f}/{y}/{x}.jpg",
        "format": "jpg",
        "size": 1024,
        "fallbackOnly": false
      },
    ...
    },
    {
      ...
      "image": {
        "base": "tiles/bureau-3/{z}/{f}/{y}/{x}.jpg",
        "format": "jpg",
        "size": 1024,
        "fallbackOnly": false
      },
    ...
    },
    {
      ...
      "image": {
        "base": "tiles/cuisine/{z}/{f}/{y}/{x}.jpg",
        "format": "jpg",
        "size": 1024,
        "fallbackOnly": false
      },
    ...
    },
    {
      ...
      "image": {
        "base": "tiles/salle-d-attente/{z}/{f}/{y}/{x}.jpg",
        "format": "jpg",
        "size": 1024,
        "fallbackOnly": false
      },
    ...
    },
    {
      ...
      "image": {
        "base": "tiles/salle-reunion/{z}/{f}/{y}/{x}.jpg",
        "format": "jpg",
        "size": 1024,
        "fallbackOnly": false
      },
    ...
    },
    {
      ...
      "image": {
        "base": "tiles/toilette-pmr/{z}/{f}/{y}/{x}.jpg",
        "format": "jpg",
        "size": 1024,
        "fallbackOnly": false
      },
